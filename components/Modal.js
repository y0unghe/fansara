                    ...
                    >
                        <div className="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full">
                            <div className="flex items-center px-1.5 py-2 border-b border-gray-200">
                                <div
                                    className=" cursor-pointer hover:text-blue-500 w-[25px] text-gray-500 flex items-center justify-center xl:px-0"
                                    ...
                                    <div className=" flex gap-x-3 relative">
                                        ...
                                        <div>
                                            <div className="inline-block group">
                                                ...
                                                <span className="ml-1.5 text-sm sm:text-[15px] text-gray-400">
                                                    @{post?.tag}{" "}
                                                </span>
                                            </div>{" "}
                                            ·{" "}
                                            <span className="hover:underline text-sm sm:text-[15px] text-gray-400">
                                    ...
                                    <div className="mt-7 flex space-x-3 w-full">
                                        ...
                                        <div className="flex-grow mt-2">
                                            <textarea
                                                ...
                                                placeholder="Pose your reply"
                                                rows="2"
                                                className="bg-transparent outline-none text-black text-lg placeholder-gray-400 tracking-wide w-full min-h-[80px]"
                                            />
